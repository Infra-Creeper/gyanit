...
import { COURSES, DOMAINS, STATS } from '../data/mockData';
    ...
    <div>
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          ...
          <h1>
            Learn, Attempt, Earn.<br />
            <em>Grow with Gyan.</em>
          </h1>
          <p>
            Structured courses by expert instructors. Watch videos, attempt quizzes,
            and earn verified certificates — just like NPTEL, but free for everyone.
          </p>
        ...
        <div className={styles.domainGrid}>
          {DOMAINS.map((d) => (
            <div
              ...
              style={{ '--thumb-bg': d.color }}
              onClick={() => navigate(`/courses?domain=${d.id}`)}
            >
      ...
      <section className={styles.section}>
        ...
        <div className={styles.stepsGrid}>
          {[
            { icon: <Play size={24} />, step: '01', title: 'Watch Lectures', desc: 'Learn from expert instructors through structured video modules.' },
            { icon: <TrendingUp size={24} />, step: '02', title: 'Attempt Quizzes', desc: 'Test your understanding with module-end quizzes and get instant feedback.' },
            { icon: <Award size={24} />, step: '03', title: 'Earn Certificate', desc: 'Pass all quizzes to earn a verified certificate you can share.' },
          ].map((s) => (
